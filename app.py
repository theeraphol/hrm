...
@bp.route('/login')
def login():
    """เริ่มกระบวนการเข้าสู่ระบบผ่าน SSO ถ้ามีการตั้งค่าและอ่านข้อมูลจาก token"""
    if oauth:
        ...
        if token_param:
            ...
            session['staff_profile'] = {k: userinfo.get(k) for k in [
                'id', 'username', 'email', 'full_name', 'phone',
                'position', 'department_code', 'job_code', 'status',
